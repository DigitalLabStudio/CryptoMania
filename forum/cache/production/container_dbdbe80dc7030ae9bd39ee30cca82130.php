...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004cbbde40000000001d4ad5d8(
...
class phpbbtemplatetwiglexer_000000004cbbde40000000001d4ad5d8 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a65f65a58b3a470623322 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a65f65a58b43095536632 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a65f65a58b1d976592025 = array(
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, 'set_environment', array('env' => $env), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;

        return $this->valueHolder5a65f65a58b3a470623322->set_environment($env);
    }
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;

        return $this->valueHolder5a65f65a58b3a470623322->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;

        return $this->valueHolder5a65f65a58b3a470623322->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a65f65a58b43095536632 = $initializer;
    }
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, '__get', array('name' => $name), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;

        if (isset(self::$publicProperties5a65f65a58b1d976592025[$name])) {
            return $this->valueHolder5a65f65a58b3a470623322->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a65f65a58b3a470623322;
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, '__isset', array('name' => $name), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, '__unset', array('name' => $name), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;
    ...
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, '__clone', array(), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;

        $this->valueHolder5a65f65a58b3a470623322 = clone $this->valueHolder5a65f65a58b3a470623322;
    }

    public function __sleep()
    {
        $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, '__sleep', array(), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;

        return array('valueHolder5a65f65a58b3a470623322');
    }
    ...
    {
        return $this->initializer5a65f65a58b43095536632;
    }
    ...
    {
        return $this->initializer5a65f65a58b43095536632 && ($this->initializer5a65f65a58b43095536632->__invoke($valueHolder5a65f65a58b3a470623322, $this, 'initializeProxy', array(), $this->initializer5a65f65a58b43095536632) || 1) && $this->valueHolder5a65f65a58b3a470623322 = $valueHolder5a65f65a58b3a470623322;
    }
    ...
    {
        return null !== $this->valueHolder5a65f65a58b3a470623322;
    }
    ...
    {
        return $this->valueHolder5a65f65a58b3a470623322;
    }

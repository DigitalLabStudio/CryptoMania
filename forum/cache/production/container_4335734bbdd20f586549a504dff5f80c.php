...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000167d667000000000303f27ce(
...
class phpbbtemplatetwiglexer_00000000167d667000000000303f27ce extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a65f2e28eed3045545098 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a65f2e28eedb352980377 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a65f2e28eeb6202003572 = array(
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, 'set_environment', array('env' => $env), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;

        return $this->valueHolder5a65f2e28eed3045545098->set_environment($env);
    }
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;

        return $this->valueHolder5a65f2e28eed3045545098->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;

        return $this->valueHolder5a65f2e28eed3045545098->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a65f2e28eedb352980377 = $initializer;
    }
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, '__get', array('name' => $name), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;

        if (isset(self::$publicProperties5a65f2e28eeb6202003572[$name])) {
            return $this->valueHolder5a65f2e28eed3045545098->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a65f2e28eed3045545098;
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, '__isset', array('name' => $name), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, '__unset', array('name' => $name), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;
    ...
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, '__clone', array(), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;

        $this->valueHolder5a65f2e28eed3045545098 = clone $this->valueHolder5a65f2e28eed3045545098;
    }

    public function __sleep()
    {
        $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, '__sleep', array(), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;

        return array('valueHolder5a65f2e28eed3045545098');
    }
    ...
    {
        return $this->initializer5a65f2e28eedb352980377;
    }
    ...
    {
        return $this->initializer5a65f2e28eedb352980377 && ($this->initializer5a65f2e28eedb352980377->__invoke($valueHolder5a65f2e28eed3045545098, $this, 'initializeProxy', array(), $this->initializer5a65f2e28eedb352980377) || 1) && $this->valueHolder5a65f2e28eed3045545098 = $valueHolder5a65f2e28eed3045545098;
    }
    ...
    {
        return null !== $this->valueHolder5a65f2e28eed3045545098;
    }
    ...
    {
        return $this->valueHolder5a65f2e28eed3045545098;
    }
